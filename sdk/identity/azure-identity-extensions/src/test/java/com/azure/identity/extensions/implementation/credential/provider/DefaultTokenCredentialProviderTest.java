...
class DefaultTokenCredentialProviderTest {
    ...
    @ParameterizedTest
    @ValueSource(classes = { DefaultTokenCredentialProvider.class, CacheTokenCredentialProvider.class })
    ...
    void testClientSecretCredential(String providedAuthorityHost) {
        ...
        verifyClientSecretCredentialByProvider(options, CacheTokenCredentialProvider.class);
    }
    ...
    void testClientCertificateCredential(String providedAuthorityHost) {
        ...
        verifyClientCertificateCredentialByProvider(options, CacheTokenCredentialProvider.class);
    }
    ...
    void testUsernamePasswordCredential(String providedAuthorityHost) {
        ...
        verifyUsernamePasswordCredentialByProvider(options, CacheTokenCredentialProvider.class);
    }
    ...
    void testManagedIdentityCredential() {
        ...
        verifyManagedIdentityCredentialByProvider(options, CacheTokenCredentialProvider.class);
    }
    ...
    void testDefaultAzureCredential() {
        ...
        verifyDefaultCredentialByProvider(options, CacheTokenCredentialProvider.class);
    }
