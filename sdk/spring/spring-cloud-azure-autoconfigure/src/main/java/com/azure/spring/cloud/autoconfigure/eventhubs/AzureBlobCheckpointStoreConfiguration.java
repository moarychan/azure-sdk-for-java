...
@ConditionalOnClass({ EventHubClientBuilder.class, BlobCheckpointStore.class })
@ConditionalOnAnyProperty(prefix = "spring.cloud",
    name = {"azure.eventhubs.processor.checkpoint-store.account-name", "stream.binders"}
)
